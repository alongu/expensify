...
// The dispatch will send the state to the store for BOTH reducers, 
// but we only set handling of the method we want in the relevant reducer.
// for example: if we want to ADD_EXPENSE - we will handle it ONLY in the expenses reducer
